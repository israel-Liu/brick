...
#ifndef BRICK_JSON_STRING_ESCAPE_H_
#define BRICK_JSON_STRING_ESCAPE_H_
...
BRICK_EXPORT bool EscapeJSONString(StringPiece str,
                                  bool put_in_quotes,
                                  std::string* dest);
...
BRICK_EXPORT bool EscapeJSONString(StringPiece16 str,
                                  bool put_in_quotes,
                                  std::string* dest);

// Helper functions that wrap the above two functions but return the value
// instead of appending. |put_in_quotes| is always true.
BRICK_EXPORT std::string GetQuotedJSONString(StringPiece str);
BRICK_EXPORT std::string GetQuotedJSONString(StringPiece16 str);
...
BRICK_EXPORT std::string EscapeBytesAsInvalidJSONString(StringPiece str,
                                                       bool put_in_quotes);

}  // namespace base

#endif  // BRICK_JSON_STRING_ESCAPE_H_
