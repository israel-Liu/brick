...
#ifndef BRICK_ANDROID_JNI_WEAK_REF_H_
#define BRICK_ANDROID_JNI_WEAK_REF_H_
...
class BRICK_EXPORT JavaObjectWeakGlobalRef {
 public:
...
// ScopedJavaLocalRef.
BRICK_EXPORT base::android::ScopedJavaLocalRef<jobject> GetRealObject(
    JNIEnv* env, jweak obj);

#endif  // BRICK_ANDROID_JNI_WEAK_REF_H_
