...
#ifndef BRICK_ANDROID_LIBRARY_LOADER_LIBRARY_LOADER_HOOKS_H_
#define BRICK_ANDROID_LIBRARY_LOADER_LIBRARY_LOADER_HOOKS_H_
...
BRICK_EXPORT void SetNativeInitializationHook(
...
BRICK_EXPORT void RecordLibraryLoaderRendererHistograms();
...
BRICK_EXPORT void SetLibraryLoadedHook(LibraryLoadedHook* func);
...
BRICK_EXPORT void SetVersionNumber(const char* version_number);

// Call on exit to delete the AtExitManager which OnLibraryLoadedOnUIThread
// created.
BRICK_EXPORT void LibraryLoaderExitHook();
...
#endif  // BRICK_ANDROID_LIBRARY_LOADER_LIBRARY_LOADER_HOOKS_H_
