...
#ifndef BRICK_TASK_SEQUENCE_MANAGER_SEQUENCED_TASK_SOURCE_H_
#define BRICK_TASK_SEQUENCE_MANAGER_SEQUENCED_TASK_SOURCE_H_
...
#endif  // BRICK_TASK_SEQUENCE_MANAGER_SEQUENCED_TASK_SOURCE_H_
