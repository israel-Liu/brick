...
#ifndef BRICK_PROCESS_MEMORY_H_
#define BRICK_PROCESS_MEMORY_H_
...
BRICK_EXPORT void EnableTerminationOnHeapCorruption();

// Turns on process termination if memory runs out.
BRICK_EXPORT void EnableTerminationOnOutOfMemory();

// Terminates process. Should be called only for out of memory errors.
// Crash reporting classifies such crashes as OOM.
BRICK_EXPORT void TerminateBecauseOutOfMemory(size_t size);

#if defined(OS_LINUX) || defined(OS_ANDROID) || defined(OS_AIX)
BRICK_EXPORT extern size_t g_oom_size;
...
BRICK_EXPORT bool AdjustOOMScore(ProcessId process, int score);
#endif
...
BRICK_EXPORT WARN_UNUSED_RESULT bool UncheckedMalloc(size_t size,
                                                    void** result);
BRICK_EXPORT WARN_UNUSED_RESULT bool UncheckedCalloc(size_t num_items,
                                                    size_t size,
                                                    void** result);

}  // namespace base

#endif  // BRICK_PROCESS_MEMORY_H_
