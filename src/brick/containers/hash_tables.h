...
#ifndef BRICK_CONTAINERS_HASH_TABLES_H_
#define BRICK_CONTAINERS_HASH_TABLES_H_
...
#define BRICK_HASH_NAMESPACE base_hash

namespace BRICK_HASH_NAMESPACE {

// A separate hasher which, by default, forwards to std::hash. This is so legacy
// uses of BRICK_HASH_NAMESPACE with base::hash_map do not interfere with
...
// Use base::IntPairHash from brick/hash.h as a custom hasher instead.
...
template <class Key,
          class T,
          class Hash = BRICK_HASH_NAMESPACE::hash<Key>,
...
#endif  // BRICK_CONTAINERS_HASH_TABLES_H_
