...
#ifndef BRICK_I18N_BIDI_LINE_ITERATOR_H_
#define BRICK_I18N_BIDI_LINE_ITERATOR_H_
...
class BRICK_I18N_EXPORT BiDiLineIterator {
 public:
...
#endif  // BRICK_I18N_BIDI_LINE_ITERATOR_H_
