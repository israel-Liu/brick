...
#ifndef BRICK_I18N_ICU_STRING_CONVERSIONS_H_
#define BRICK_I18N_ICU_STRING_CONVERSIONS_H_

#include <string>

#include "brick/i18n/base_i18n_export.h"
#include "brick/i18n/i18n_constants.h"
...
// returns false.
BRICK_I18N_EXPORT bool UTF16ToCodepage(const string16& utf16,
                                      const char* codepage_name,
                                      OnStringConversionError::Type on_error,
                                      std::string* encoded);
BRICK_I18N_EXPORT bool CodepageToUTF16(const std::string& encoded,
                                      const char* codepage_name,
                                      OnStringConversionError::Type on_error,
                                      string16* utf16);
...
// normalized.
BRICK_I18N_EXPORT bool ConvertToUtf8AndNormalize(const std::string& text,
                                                const std::string& charset,
                                                std::string* result);

}  // namespace base

#endif  // BRICK_I18N_ICU_STRING_CONVERSIONS_H_
