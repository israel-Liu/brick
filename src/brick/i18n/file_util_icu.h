...
#ifndef BRICK_I18N_FILE_UTIL_ICU_H_
#define BRICK_I18N_FILE_UTIL_ICU_H_
...
BRICK_I18N_EXPORT bool IsFilenameLegal(const string16& file_name);
...
BRICK_I18N_EXPORT void ReplaceIllegalCharactersInPath(
...
// std::sort.
BRICK_I18N_EXPORT bool LocaleAwareCompareFilenames(const FilePath& a,
                                                  const FilePath& b);
...
BRICK_I18N_EXPORT void NormalizeFileNameEncoding(FilePath* file_name);

}  // namespace i18n
}  // namespace base

#endif  // BRICK_I18N_FILE_UTIL_ICU_H_
