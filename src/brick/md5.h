...
// MD5Update().
BRICK_EXPORT void MD5Init(MD5Context* context);
...
BRICK_EXPORT void MD5Update(MD5Context* context, const StringPiece& data);

// Finalizes the MD5 operation and fills the buffer with the digest.
BRICK_EXPORT void MD5Final(MD5Digest* digest, MD5Context* context);
...
BRICK_EXPORT void MD5IntermediateFinal(MD5Digest* digest,
                                      const MD5Context* context);

// Converts a digest into human-readable hexadecimal.
BRICK_EXPORT std::string MD5DigestToBase16(const MD5Digest& digest);

// Computes the MD5 sum of the given data buffer with the given length.
// The given 'digest' structure will be filled with the result data.
BRICK_EXPORT void MD5Sum(const void* data, size_t length, MD5Digest* digest);

// Returns the MD5 (in hexadecimal) of a string.
BRICK_EXPORT std::string MD5String(const StringPiece& str);
