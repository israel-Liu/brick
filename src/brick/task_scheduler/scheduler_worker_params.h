...
#ifndef BRICK_TASK_SCHEDULER_SCHEDULER_WORKER_PARAMS_H_
#define BRICK_TASK_SCHEDULER_SCHEDULER_WORKER_PARAMS_H_
...
#endif  // BRICK_TASK_SCHEDULER_SCHEDULER_WORKER_PARAMS_H_
