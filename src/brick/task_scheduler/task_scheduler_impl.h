...
#ifndef BRICK_TASK_SCHEDULER_TASK_SCHEDULER_IMPL_H_
#define BRICK_TASK_SCHEDULER_TASK_SCHEDULER_IMPL_H_
...
class BRICK_EXPORT TaskSchedulerImpl : public TaskScheduler {
 public:
...
#endif  // BRICK_TASK_SCHEDULER_TASK_SCHEDULER_IMPL_H_
