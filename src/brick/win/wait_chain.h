...
#ifndef BRICK_WIN_WAIT_CHAIN_H_
#define BRICK_WIN_WAIT_CHAIN_H_
...
BRICK_EXPORT bool GetThreadWaitChain(DWORD thread_id,
...
BRICK_EXPORT base::string16 WaitChainNodeToString(
    const WAITCHAIN_NODE_INFO& node);

}  // namespace win
}  // namespace base

#endif  // BRICK_WIN_WAIT_CHAIN_H_
