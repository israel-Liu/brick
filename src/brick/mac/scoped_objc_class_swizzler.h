...
#ifndef BRICK_MAC_SCOPED_OBJC_CLASS_SWIZZLER_H_
#define BRICK_MAC_SCOPED_OBJC_CLASS_SWIZZLER_H_
...
class BRICK_EXPORT ScopedObjCClassSwizzler {
 public:
...
#endif  // BRICK_MAC_SCOPED_OBJC_CLASS_SWIZZLER_H_
