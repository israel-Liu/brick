...
#ifndef BRICK_BASE64URL_H_
#define BRICK_BASE64URL_H_
...
BRICK_EXPORT void Base64UrlEncode(const StringPiece& input,
...
BRICK_EXPORT bool Base64UrlDecode(const StringPiece& input,
                                 Base64UrlDecodePolicy policy,
                                 std::string* output) WARN_UNUSED_RESULT;

}  // namespace base

#endif  // BRICK_BASE64URL_H_
